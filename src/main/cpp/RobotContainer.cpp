...
void RobotContainer::ConfigureSysIDBindings() {
  m_operatorController.A().WhileTrue(m_driveSubsystem.SysIdDynamic(frc2::sysid::kForward));
  m_operatorController.B().WhileTrue(m_driveSubsystem.SysIdDynamic(frc2::sysid::kReverse));
  m_operatorController.X().WhileTrue(m_driveSubsystem.SysIdQuasistatic(frc2::sysid::kForward));
  m_operatorController.Y().WhileTrue(m_driveSubsystem.SysIdQuasistatic(frc2::sysid::kReverse));
}
