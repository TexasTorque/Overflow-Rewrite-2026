...
class CommandSwerveDrivetrain : public frc2::SubsystemBase,
                                ...
                                public VisionMeasurementConsumer {
  ...
  frc2::sysid::SysIdRoutine m_sysIdRoutineTranslation{
      frc2::sysid::Config{std::nullopt,  // Use default ramp rate (1 V/s)
      ...
      frc2::sysid::Mechanism{
          [this](units::volt_t output) { SetControl(m_translationCharacterization.WithVolts(output)); }, {}, this}};
  ...
  frc2::sysid::SysIdRoutine m_sysIdRoutineSteer{
      ...
      frc2::sysid::Mechanism{
          [this](units::volt_t output) { SetControl(m_steerCharacterization.WithVolts(output)); }, {}, this}};
  ...
  frc2::sysid::SysIdRoutine m_sysIdRoutineRotation{
      frc2::sysid::Config{/* This is in radians per second², but SysId only supports "volts per second" */
 ...
 public:
  ...
  CommandSwerveDrivetrain(swerve::SwerveDrivetrainConstants const& driveTrainConstants,
      ...
      : TunerSwerveDrivetrain{driveTrainConstants, odometryUpdateFrequency, odometryStandardDeviation,
  ...
  frc2::CommandPtr ApplyRequest(RequestSupplier request) {
    return Run([this, request = std::move(request)] { return SetControl(request()); });
  }
